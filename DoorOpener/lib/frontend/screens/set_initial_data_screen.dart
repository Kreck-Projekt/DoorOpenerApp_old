                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppLocalizations.of(context).translate('first_start_explanation'),
                          ...
                          child: Column(
                            children: <Widget>[
                              TextFormField(
                                ...
                                decoration:
                                    inputDecorationHandler(context, 'first_start_ip_label', 'first_start_ip_hint'),
                              ),
                              const SizedBox(
                                height: 30,
                              ),
                              ...
                              TextFormField(
                                ...
                                decoration:
                                    inputDecorationHandler(context, 'first_start_open_label', 'first_start_open_hint'),
                              ),
                            ],
                          ),
                        ),
          ...
          return FloatingActionButton(
            ...
            onPressed: () async {
              if (_formKey.currentState.validate()) {
                final String ipAddress = ipController.text;
                final int port = int.parse(portController.text);
                final int time = int.parse(openController.text);
                final bool success = await DataManager.setInitialData(ipAddress, port, time);
                if (success) {

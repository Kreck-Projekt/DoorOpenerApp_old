                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                      ...
                      title: Text(
                        AppLocalizations.of(context).translate('settings_screen_change_password'),
                    ...
                    ListTile(
                      ...
                      title: Text(
                        AppLocalizations.of(context).translate('settings_screen_add_device'),
                        style: Theme.of(context).textTheme.headline1.copyWith(
                              fontSize: 20,
                              fontWeight: FontWeight.normal,
                            ),
                    ...
                    ListTile(
                      ...
                      title: Text(
                        AppLocalizations.of(context).translate('settings_screen_ip_change'),
                        style: Theme.of(context).textTheme.headline1.copyWith(
                              fontSize: 20,
                              fontWeight: FontWeight.normal,
                            ),
                    ...
                    ListTile(
                      ...
                      title: Text(
                        AppLocalizations.of(context).translate('settings_screen_app_reset'),
                        style: Theme.of(context).textTheme.headline1.copyWith(
                              fontSize: 20,
                              fontWeight: FontWeight.normal,
                            ),
                    ...
                    ListTile(
                      ...
                      title: Text(
                        AppLocalizations.of(context).translate('settings_screen_full_reset'),
                        style: Theme.of(context).textTheme.headline1.copyWith(
                              fontSize: 20,
                              fontWeight: FontWeight.normal,
                            ),
                    ...
                    ListTile(
                      ...
                      title: Text(
                        AppLocalizations.of(context).translate('credits_screen_title'),
                        style: Theme.of(context).textTheme.headline1.copyWith(
                              fontSize: 20,
                              fontWeight: FontWeight.normal,
                            ),
